...
const ListViewIcon = (props: WithSVGProps) => (
  <svg viewBox="0 -256 1800 1800" version="1.1" {...props}>
    <g transform="matrix(1,0,0,-1,7.5932203,1369.3559)">
...
export default withSVGProps(ListViewIcon)
